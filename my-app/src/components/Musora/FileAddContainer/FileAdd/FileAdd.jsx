...
import {fileAddActionCreator, updateMusoraTextActionCreator} from "../../../redux/MusoraPageReducer";
...
const FileAdd = (props) => {
    ...
    let clickMusora = () => {
        ...
        props.dispatch(fileAddActionCreator())
    };

    let PostChangeMP = () => {
        debugger
        let text = whereThey.current.value;
        props.dispatch(updateMusoraTextActionCreator(text))
    };
